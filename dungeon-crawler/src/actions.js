...
export function playAction(attackType, hand = 'left', memberIndex = 0, elementId = null) {
  ...
  if (attackType === ACTIONS.FIREBALL || attackType === ACTIONS.FROSTBOLT || attackType === ACTIONS.WATERBOLT || attackType === ACTIONS.LIGHTNINGBOLT || attackType === ACTIONS.HOLYBOLT || attackType === ACTIONS.DARKBOLT || attackType === ACTIONS.BANISHMENT || attackType === ACTIONS.REGENERATE || attackType === ACTIONS.INCINERATE) {
    return;
  }
