...
export function spawnLevel0Objects(ctx) {
    ...
    addChest(group, loader, 13.4, 10, Math.PI / 2, -0.1, [
        ...
        'Potion of Unseen', 'Potion of Unseen', 'Potion of Unseen', { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }, { "name": "Elixir of Rage", "hq": true }
    ...
    if (level3PortalEnabled) {
        addPortal(group, loader, 12, 13, 3, 0, 0, 0.85, 27, 11, 0); // Middle
    } else {
