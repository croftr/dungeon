...
export const RECRUITS = [
    {
        ...
        skills: [
            { name: 'Entangle', type: 'debuff', delay: 60, description: 'Halves the attack speed of the monster currently being fought for 30s. Only usable in combat. Cooldown: 60s.', icon: '/skills/entangle.png' },
            { name: "Hunter's Eye", type: 'debuff', delay: 60, description: "Reveal full stats of the engaged monster — HP, STR, DEX, VIT, INT, RES and Defence. Only usable in combat.", icon: '/skills/hunters-eye.png' },
        ],
        image: '/elf_ranger_head.png',
        leftHand: 'Short Bow', rightHand: '—', ammo: 'Wooden Arrows', startingSkill: "Hunter's Eye",
    ...
    },
    {
        ...
        skills: [
            { name: 'Sanctuary', type: 'buff', delay: 120, description: 'Surrounds the party in divine light, reducing all damage received by 10% for 60 seconds. Cooldown: 120s.', icon: '/skills/sancturary.png' },
            { name: 'Holy Radiance', type: 'healing', delay: 120, description: 'Calls down a pulse of holy energy, restoring 10 HP to every living party member. Cooldown: 120s.', icon: '/skills/holy-radiance.png' },
        ],
    ...
    },
    {
        ...
        skills: [
            { name: 'Sunder Armor', type: 'debuff', delay: 60, description: 'Crushes the targeted monster, halving its defence stats for 30s. Only usable in combat. Cooldown: 60s.', icon: '/skills/sunder-armor.png' },
            { name: 'Miners Light', type: 'buff', delay: 60, description: 'Ignites a specialized lantern, illuminating the dungeon brightly for 60 seconds. Cooldown: 60s.', icon: '/skills/arcane-lantern.png' },
        ],
    ...
    },
    {
        ...
        skills: [
            { name: 'Arcane Lantern', type: 'buff', delay: 60, description: 'Conjures a sphere of magical light that illuminates the dungeon as brightly as a torch for 60 seconds. Cooldown: 60s.', icon: '/skills/arcane-lantern.png' },
            { name: 'Runic Scholar', type: 'buff', delay: 0, description: 'Channels arcane power into the next spell cast, doubling its damage after all other modifiers are applied.', icon: '/skills/runic-scholar.png' },
            { name: 'Mana Tap', type: 'healing', delay: 120, description: 'Taps into a hidden vein of arcane energy, instantly replenishing all of Merlin\'s mana points. Cooldown: 120s.', icon: '/skills/mana-tap.png' },
        ],
    ...
    },
    {
        ...
        skills: [
            { name: 'Berserk', type: 'buff', delay: 60, description: 'Enters a state of roaring fury, boosting all damage dealt by 20% (after other calculations) for 30s. Cooldown: 60s.', icon: '/skills/berserk.png' },
            { name: 'Heal', type: 'healing', attackType: 'heal', delay: 15, description: 'A wave of restorative energy that mends wounds. Restores HP equal to the casters Intelligence to one party member.', icon: '/skills/heal.png' }
        ],
    ...
    },
    {
        ...
        skills: [
            { name: 'True Shot', type: 'buff', delay: 60, description: 'Becomes hyper-focused, ensuring every ranged attack finds its mark for 20 seconds. Cooldown: 60s.', icon: '/skills/true-shot.png' },
        ],
    ...
    },
    {
        ...
        skills: [
            { name: 'Whirlwind', type: 'buff', delay: 60, description: 'Becomes a blur of motion, doubling attack speed and preventing stamina drain for 30s. Cooldown: 60s.', icon: '/skills/whirlwind.png' },
        ],
